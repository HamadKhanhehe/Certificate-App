...
// import Template from '../../components/ctemp/Template';
...
//     if (!name.trim() || !courseDate.trim() || !instructorName.trim()) return; // Prevent download if any field is empty
...
//     if (name.trim() && courseDate.trim() && instructorName.trim()) {
